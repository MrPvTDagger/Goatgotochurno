class WeaponShops {  
    ...
    class basic {
        ...
        items[] = {
			...
			{ "rhsusf_acc_nt4_black", "RHS M16A4 Suppressor Black", 200, 100, "" },
        ...
        items[] = {
         ...
         { "rhs_weap_m16a4_carryhandle_pmag", "", 5000, 2500, "" },
        ...
        items[] = {	
			...
			{ "rhs_weap_m240b", "", 9000, 4500, "" },	
			{ "rhs_weap_m249", "", 8000, 5000, "" },	
			{ "rhs_weap_m249_pip_L", "", 8000, 4000, "" },	
			{ "rhs_weap_m249_pip_S", "", 8000, 4000, "" },
	        { "arifle_MX_SW_F", "", 6000, 3000, "" },
	        { "arifle_MX_SW_Black_F", "", 6000, 3000, "" },			
